...
//     // tslint:disable-next-line:no-any
//     sendRequest(code: CommunicationCodes, body: any, queueName: string, ip?: string, user?: IUser): Promise<any> {
...
//     publishMessageWithCode(code: CommunicationCodes, body: any, queueName: string, user?: IUser): void {
